...
[DraWe](/posts/project-drawe/)에서 EKS를 다루면서 계속 걸리는 게 있었습니다. **관리형은 컨트롤 플레인을 가려줍니다.** 편하지만, 그 안에서 무슨 일이 일어나는지는 끝내 모릅니다. 그래서 노트북 VM 위에 **kubeadm으로 직접** 클러스터를 세웠습니다. 비용 0으로 스케줄링·CNI·스토리지·인증서를 직접 만지려고.
